...
import Sidebar from "./FinanceSidebar"; // Asegúrate de que la ruta sea correcta
import RequestItem from "./FinanceRequestItem"; // Asegúrate de que la ruta sea correcta
