...
export default function FinanceDashboard() {
  ...
  // 🔥 CONTAR REQUISICIONES DE FINANZAS (roleId = 5)
  const financeRequestsCount = requisitions.filter(
    (req) => req.roleId === Role.Finanzas
  ).length;
  ...
  const options = [
    {
      ...
      requestCount: financeRequestsCount, // 👈 DINÁMICO
    },
  ];
