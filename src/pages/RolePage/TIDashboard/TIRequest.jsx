...
import Sidebar from "./TISidebar"; // Asegúrate de que la ruta sea correcta
import RequestItem from "./TIRequestItem"; // Asegúrate de que la ruta sea correcta
        ...
        <main className="flex-1 p-6 overflow-y-auto   ">
          <div className="flex items-center border-b p-4 mx-2">
            ...
            <TextButton
              ...
              text={"Atras"}
            />
            <h1 className="px-9 text-3xl p-4"> Lista de Requisiciones - TI</h1>
          </div>
          {selectedParentId ? (
