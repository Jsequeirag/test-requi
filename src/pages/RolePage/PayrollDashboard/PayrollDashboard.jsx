...
export default function PayrollDashboard() {
  ...
  // 🔥 CONTAR REQUISICIONES DE PAYROLL (roleId = 6)
  const payrollRequestsCount = requisitions.filter(
    (req) => req.roleId === Role.Payroll
  ).length;
  ...
  const options = [
    {
      ...
      requestCount: payrollRequestsCount, // 👈 DINÁMICO
    },
  ];
