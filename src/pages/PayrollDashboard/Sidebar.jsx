...
const Sidebar = ({ onParentSelect, setChildRequestsData }) => {
  ...
  return (
    <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md shadow-lg p-5 w-72 flex-shrink-0 border-r border-gray-200 dark:border-gray-800 h-full overflow-y-auto flex flex-col">
      {/* Header */}
