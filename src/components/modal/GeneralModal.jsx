...
export default function GeneralModal({
  ...
  return (
    ...
    <div
      className={`modal fixed z-50 left-0 top-0 w-full h-full  overflow-auto backdrop-opacity-10 backdrop-invert bg-gray-950/30 `}
      style={{ display: openModal ? "block" : "none" }}
    >
      <div
        className={`modal-content  pc:w-[50%] movil:w-[100%] mt-[10%] m-auto pt-1 pr-1 border bg-slate-50 rounded-sm`}
      >
